...
grant select (id, author_name, content, is_anonymous, created_at) on public.science_lab_questions to anon, authenticated;
...
grant insert (content, is_anonymous) on public.science_lab_questions to authenticated;
